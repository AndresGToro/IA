...
public class RfacialActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraBridgeViewBase = new JavaCameraView(this,CameraBridgeViewBase.CAMERA_ID_FRONT);
    ...
    public Mat onCameraFrame(Mat src) {
        ...
        if (detector != null && !detector.empty()) {
            detector.detectMultiScale(gray, faces, 1.3, 2, 2, new Size(200, 200), new Size());
        }
