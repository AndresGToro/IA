...
public class CarActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case BaseLoaderCallback.SUCCESS: {
                    ...
                    String path = CascadeHelper.generateXmlPath(this.mAppContext, R.raw.car);
