...
public class CascadeActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener{
...
public void onManagerConnected(int status) {
        ...
        String path = CascadeHelper.generateXmlPath(this.mAppContext, R.raw.cascade);
